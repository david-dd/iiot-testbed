...
class SimulationEnvironment:
    ...
    def getAvailableActionSpace(self):
        ...
        for k, station in enumerate(self.config.stations):
            if str(nextOp) in station["Operations"].keys():
                ...
                # Der Agent darf auch Stationen wählen, die aktuell in Störung sind, dann muss er halt mit der Entshceidung leben....    
        ...
        # Nun ermitteln welceh Pfade zurverfügung stehen
    ...
    def shouldAskAgain(self, car, nextDestination, slot):
        ...
        BreakdownState = self.stations[stationKeyDest]["Operations"][str(nextOp)]["BreakdownState"]
    ...
    def calcReward(self):
        ...
        if lenFinishedProducts == 0:
            makespanPerProduct = 1000
        else:
            makespanPerProduct = makespan / lenFinishedProducts
